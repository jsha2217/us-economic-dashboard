...
### 대시보드 메인
전체 경제 지표와 Quick Metrics를 한눈에 확인할 수 있습니다.
...
### Quick Metrics
주요 경제 지표 5개를 카드 형태로 빠르게 확인

![Quick Metrics](docs/screenshots/quick-metrics.png)

---

### AI 경제 분석
Google Gemini 2.5 Flash가 경제 상황을 분석하고 증시 전망을 제시합니다.
...
### 인터랙티브 차트
5개 카테고리의 경제 지표를 시각화한 인터랙티브 차트

![Charts](docs/screenshots/charts.png)

- 📈 **금리 추이**: 연준 기준금리, 10년물/2년물 국채, 장단기 금리차
- 📈 **물가 지수**: CPI, Core CPI, PCE, Core PCE
- 💼 **고용 지표**: 실업률, 비농업 고용
- 📊 **GDP 성장**: Real GDP, 성장률, 산업생산
- 🔮 **경기선행지수**: 소비자심리, 주택허가, 소매판매
